...
export default function EditCalendarEventPage({ params }: { params: EventoParams | Promise<EventoParams> }) {
  ...
  useEffect(() => {
    const fetchEvent = async () => {
      try {
        ...
        // Converter datas de ISO para o formato local esperado pelo input datetime-local
        ...
        setForm({
          ...
          regulationpdf: eventData.regulationpdf,
        })
  ...
  // Remover regulamento existente
  const handleRemoveExistingRegulation = () => {
    setForm((prev) => ({ ...prev, regulationpdf: undefined }))
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 1. Upload dos arquivos novos se houver
      ...
      const eventData = {
        ...
        regulationpdf: uploaded.regulationUrl || form.regulationpdf,
      }
      
      // 3. Atualizar evento via API
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-2">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Editar Evento do Calendário</h1>
      </div>
      ...
      {success && (
        <div className="bg-green-50 border-l-4 border-green-500 p-4 my-4">
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-green-700">Evento atualizado com sucesso! Redirecionando...</p>
            </div>
          </div>
        </div>
      )}
          ...
          <div className="p-6 space-y-4">
              ...
              {form.imageurl ? (
                <div className="mt-2 flex items-center space-x-4">
                  ...
                  <button
                    ...
                    className="py-1 px-3 border border-red-300 rounded-md text-sm text-red-700 hover:bg-red-50"
                  >
                    Remover imagem
                  </button>
                </div>
            ...
            <div>
              ...
              {form.regulationpdf ? (
                <div className="mt-2 flex items-center space-x-4">
                  <a 
                    href={form.regulationpdf} 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="py-2 px-3 bg-gray-200 rounded-md text-sm text-gray-700 hover:bg-gray-300 flex items-center"
                  >
                  ...
                  <button
                    type="button"
                    onClick={handleRemoveExistingRegulation}
                    className="py-1 px-3 border border-red-300 rounded-md text-sm text-red-700 hover:bg-red-50"
                  >
                    Remover regulamento
                  </button>
