...
import { Plus, RefreshCw, Trash2, QrCode, ArrowLeft } from 'lucide-react';
import { evolutionService, InstanceStatus } from '@/lib/whatsapp/evolution-service';
import Link from 'next/link';
import { QRCodeModal } from '@/app/dashboard/notificacoes/whatsapp/components/qr-code-modal';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Gerenciador de WhatsApp</h1>
